...
# Lab 2 cost model checked for GCP asia-southeast1 on 2026-09-17.
# Spot prices vary over time; the study uses a 30% on-demand estimate.
# The comparison report records the measured job durations and estimated spend.
